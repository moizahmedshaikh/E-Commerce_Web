        ...
        <div className="grid md:grid-cols-2 grid-cols-1 lg:gap-32 md:gap-20 gap-12 pt-8">
          ...
          <div>
            ...
            <div
              ...
              className="md:w-[50%] w-full py-3 px-4 mt-7 bg-[#DB4444] hover:bg-[#a82929] text-white rounded-sm cursor-pointer text-center"
            >
              Place Order
            </div>
          </div>
      ...
      {trackingObj && (
        <div className="mt-8 flex justify-center">
          ...
          <h2 className="text-xl text-center font-semibold text-gray-800 mb-4">
            Tracking thinks <br /> (We are using ShipEngine test api key so order will
            not trace)
          </h2>
          <p className="text-center">tracking number: {trackingObj.trackingNumber}</p>
          <p className="text-center"> labelId: {trackingObj.labelId}</p>
          <p className="text-center"> carrierCode: {trackingObj.carrierCode}</p>
          <Link href={`/tracking/?labelId=${trackingObj.labelId}`} className="flex justify-center mt-5">
